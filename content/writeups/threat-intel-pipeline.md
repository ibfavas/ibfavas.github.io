...
![Pipeline architecture](/writeups/assets/threat-intel-pipeline/01-architecture-diagram.png)
...
![Feed ingestion output](/writeups/assets/threat-intel-pipeline/02-feed-ingestion-all-feeds.png)
...
![SQLite stats and feed health](/writeups/assets/threat-intel-pipeline/03-sqlite-stats-feed-health.png)
...
![SQLite deduplication query](/writeups/assets/threat-intel-pipeline/04-sqlite-dedup-hit-count.png)
...
![Scoring report](/writeups/assets/threat-intel-pipeline/05-scoring-report.png)
...
![API enrichment and DB query](/writeups/assets/threat-intel-pipeline/06-api-enrichment-and-db.png)
...
![Wazuh CDB export](/writeups/assets/threat-intel-pipeline/07-wazuh-cdb-export-local.png)
...
![Wazuh custom rule](/writeups/assets/threat-intel-pipeline/08-wazuh-custom-rule.png)
...
![Docker Wazuh deployment](/writeups/assets/threat-intel-pipeline/09-wazuh-docker-deploy-restart.png)
...
![Wazuh logtest alert](/writeups/assets/threat-intel-pipeline/10-wazuh-logtest-alert.png)
...
![Wazuh dashboard alert](/writeups/assets/threat-intel-pipeline/11-wazuh-dashboard-alert.png)
...
![systemd timer status](/writeups/assets/threat-intel-pipeline/13-systemd-timer-status.png)
...
![systemd service journal](/writeups/assets/threat-intel-pipeline/12-systemd-journal-run.png)
